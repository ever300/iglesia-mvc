                        ...
                        <?php if (!empty($eventos)): ?>
                            <?php foreach ($eventos as $evento): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="index.php?controller=evento&action=editarEvento&id=<?= $evento['id'] ?>" class="btn btn-warning btn-sm">Editar</a>
                                        <a href="index.php?controller=evento&action=eliminarEvento&id=<?= $evento['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('¿Eliminar este evento?')">Eliminar</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        <?php else: ?>
